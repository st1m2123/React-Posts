...
export default function PrimarySearchAppBar() {
  ...
  // React.useEffect((if (localStorage.getItem('token') !== undefined) {
  ...
  function handleTimeOut(e) {
    ...
    t = setTimeout(() => {
      ...
      setRequestContext(e.target.value);
    }, '3000')
  }
      ...
      <AppBar position="static">
        <Toolbar className={s.header}>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            {autorization === null ? <div className={s.btnGap}><ModalLogin />  <Registration /></div> : <div className={s.profileBox}><div className={s.userInfo}><h5>Здраствуйте, {context.name}</h5><p>{context.about  }</p></div><Avatar onClick={handleProfileMenuOpen} alt="Remy Sharp" src={context.avatar} /></div>}
          </Box>
